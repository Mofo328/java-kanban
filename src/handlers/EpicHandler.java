                ...
                switch (exchange.getRequestMethod()) {
                    case HttpMethod.GET:
                        if (processRequest(exchange) == 0) {
                            ...
                            sendText(exchange, getGson().toJson(taskManager.getEpicById(getIdFromPath(exchange))), 200);
                            break;
                        } else if (processRequest(exchange) == -1) {
                            sendText(exchange, getGson().toJson(taskManager.getAllSubTaskByEpicId(getIdFromPath(exchange))), 200);
                            break;
                        }
